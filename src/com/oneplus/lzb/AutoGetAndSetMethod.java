 ...
 * @description:
 * @author: Zhenbin.Li
 * @createDate: 15/6/17 17:47
 */
public class AutoGetAndSetMethod extends AnAction {
     ...
     * @return 方法体的字符串
     */
    protected String getMethodText(String methodName, String returnClassName, PsiParameter psiParameter,
    ...
    protected String getFirstUpperCase(String oldStr) {
